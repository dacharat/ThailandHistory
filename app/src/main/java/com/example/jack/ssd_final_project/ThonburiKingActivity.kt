...
import kotlinx.android.synthetic.main.activity_thonburi_king.*

class ThonburiKingActivity : AppCompatActivity(), KingView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_thonburi_king)

        kingRepo = MockKingdomRepository(3)
